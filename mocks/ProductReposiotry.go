...
// ProductReposiotry is an autogenerated mock type for the ProductReposiotry type
type ProductReposiotry struct {
	mock.Mock
}

// PrintProduct provides a mock function with given fields:
func (_m *ProductReposiotry) PrintProduct() []*models.Product {
	ret := _m.Called()
...
func (_m *ProductReposiotry) PrintProductId(_a0 string) *models.Product {
	ret := _m.Called(_a0)
...
func (_m *ProductReposiotry) SaveProduct(_a0 models.Product) *models.Product {
	ret := _m.Called(_a0)
...
// UpdateP provides a mock function with given fields: _a0
func (_m *ProductReposiotry) UpdateP(_a0 models.Product) *models.Product {
	ret := _m.Called(_a0)
